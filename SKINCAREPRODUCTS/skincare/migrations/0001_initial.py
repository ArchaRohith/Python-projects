# Generated by Django 4.2.13 on 2024-05-25 20:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('basket_object', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cartitems', to='skincare.basket')),
            ],
        ),
        migrations.CreateModel(
            name='Brand',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_date', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True)),
                ('brand_object', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='skincare.brand')),
                ('category_object', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='skincare.category')),
                ('size_object', models.ManyToManyField(to='skincare.size')),
                ('tag_object', models.ManyToManyField(to='skincare.tag')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('updated_date', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True)),
                ('basket_item_objects', models.ManyToManyField(to='skincare.basketitem')),
        ...
        migrations.AddField(
            ...
            name='product_object',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='skincare.product'),
        ),
        migrations.AddField(
            model_name='basketitem',
            name='size_object',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='skincare.size'),
        ),
    ]
