...
class Product(models.Model):
    ...
    image = models.ImageField(upload_to='product_images', null=True, blank=True, default='product_images/default.jpg') #num=true db null value edukkum formil empty value submitcheyyan vendi aanu true koduthekkunne
...
class BasketItem(models.Model):
    ...
    created_date = models.DateTimeField(auto_now_add=True) #object create cheyyumpol auto-now-add work cheyyum
